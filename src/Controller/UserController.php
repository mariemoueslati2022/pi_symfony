...
class UserController extends AbstractController
{
     ...
     */
    public function profile(Request $request,$id, UserPasswordEncoderInterface $userPasswordEncoderInterface){
        $admin= $this->getDoctrine()->getRepository(user::class)->find($id);
        $form= $this->createForm(UserType::class,$admin);
        $form->handleRequest($request);
        if($form->isSubmitted() && $form->isValid()){
        ...
        return $this->render("admin/profile.html.twig",  array("formuser"=>$form->createView()));
    }
    /**
